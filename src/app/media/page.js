                                ...
                                <div className="flex flex-wrap w-full h-fit justify-center">
                                    <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-10 w-[90%] lg:w-[80%] h-fit justify-items-center">
                                        <div className="relative flex justify-center w-full max-xs:h-wallpaper-smscreen xs:h-wallpaper-mdscreen md:h-wallpaper-lgscreen">
                                            <Image src="/wallpaper_1.png" alt="wallpaper" fill={true} sizes="(max-width: 768px) 33vw, (max-width: 1200px) 25vw, 20vw" placeholder="empty"/>
                                        </div>
                                        <div className="relative flex justify-center w-full max-xs:h-wallpaper-smscreen xs:h-wallpaper-mdscreen md:h-wallpaper-lgscreen" >
                                            <Image src="/wallpaper_2.png" alt="wallpaper2" fill={true} sizes="(max-width: 768px) 33vw, (max-width: 1200px) 25vw, 20vw" placeholder="empty" />
                                        </div>
                                        <div className="relative flex justify-center w-full max-xs:h-wallpaper-smscreen xs:h-wallpaper-mdscreen md:h-wallpaper-lgscreen">
                                            <Image src="/wallpaper_3.png" alt="wallpaper3" fill={true} sizes="(max-width: 768px) 33vw, (max-width: 1200px) 25vw, 20vw" placeholder="empty"/>
                                        </div>
                                        <div className="relative flex justify-center w-full max-xs:h-wallpaper-smscreen xs:h-wallpaper-mdscreen md:h-wallpaper-lgscreen" >
                                            <Image src="/wallpaper_4.png" alt="wallpaper4" fill={true} sizes="(max-width: 768px) 33vw, (max-width: 1200px) 25vw, 20vw" placeholder="empty" />
                                        </div>
