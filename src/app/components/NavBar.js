          ...
          <div className={`hidden lg:flex justify-center w-auto`}>
            <div className="flex justify-center z-[150] w-auto rounded-full bg-gray-100 shadow-[0_15px_30px_0px_rgba(0,0,0,0.3)] px-4">
              <div className="flex lg:gap-x-10 mx-6 my-2">
                <Menu as="div" className="flex relative text-left gap-16 text-4xl xl:text-5xl py-2 font-mouse font-medium tracking-wide text-gray-800">
                ...
                <div className="mt-6 flow-root">
                  ...
                  <div className="flex w-full justify-center">
                    <div className="flex flex-col w-4/5 sm:w-1/2 justify-center ml-3 sm:ml-6 md:ml-14">
                      ...
                      {/* <a
                          type="button"
                          className="flex flex-col justify-start rounded-lg px-3 pb-6 font-mouse w-1/2 sm:w-3/5 text-5xl text-[#edfaff] font-semibold leading-10 cursor-pointer"
                          onClick={() => {
                            setMenuListener(false);
                            handleNavClickAnchor('https://www.cashewgetsajob.com/blogs/news');
                          }}
                          >
                              <span className="block">Cashew's</span>
                              <span className="block pl-4">Corner</span>
                      </a> */}
                    </div>
                  </div>
