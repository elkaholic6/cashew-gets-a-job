                            ...
                            <div className="w-[95%] sm:w-[90%] md:w-[80%] lg:w-[70%]">
                                ...
                                >
                                    <div className="w-full xl:w-[80%]">
                                        <div className="pb-0">
                                            <h1 className={`flex w-full justify-left pl-3 sm:pl-6 text-gray-800 font-sans py-2 text-lg md:text-xl lg:text-2xl font-semibold border-x-2 border-black bg-[#dbfbff] border-t-2 rounded-t-xl`}>Legal</h1>
                                        </div>
